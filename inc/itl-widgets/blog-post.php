...
class Widget_Itl_Blog_Post extends Widget_Base {
    ...
    public function get_title() {
        return __('ITL - Blog Post', 'msalon-core');
    }
            ...
            <article <?php post_class(); ?>>
			    ...
			    <header class="entry-header">
		            ...
		            <div class="entry-meta">
		                <?php menzsalon_posts_meta_header(); ?>
		            </div><!-- .entry-meta -->
		            <?php endif; ?>
			    </header>
...
Plugin::instance()->widgets_manager->register_widget_type( new Widget_Itl_Blog_Post() );