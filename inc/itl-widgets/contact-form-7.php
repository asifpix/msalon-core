...
class Widget_Itl_Contact_Form_7 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'ITL Contact Form 7', 'msalon-core' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Contact Form', 'msalon-core' )
			]
		);
		...
		$this->add_control(
			'eael_wpcf7_form',
			[
				'label'       => esc_html__( 'Select your contact form 7', 'msalon-core' ),
				'label_block' => true,
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Form Container Styles', 'msalon-core' ),
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Form Background Color', 'msalon-core' ),
		...
		$this->add_responsive_control(
			...
			[
				'label'        => esc_html__( 'Form Alignment', 'msalon-core' ),
				'type'         => Controls_Manager::CHOOSE,
				'label_block'  => true,
				'options'      => [
					'default' => [
						'title' => __( 'Default', 'msalon-core' ),
						'icon'  => 'fa fa-ban',
					],
					'left'    => [
						'title' => esc_html__( 'Left', 'msalon-core' ),
						'icon'  => 'fa fa-align-left',
					],
					'center'  => [
						'title' => esc_html__( 'Center', 'msalon-core' ),
						'icon'  => 'fa fa-align-center',
					],
					'right'   => [
						'title' => esc_html__( 'Right', 'msalon-core' ),
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Form Width', 'msalon-core' ),
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Form Max Width', 'msalon-core' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', '%' ],
				'range'      => [
					'px' => [
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Form Margin', 'msalon-core' ),
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Form Padding', 'msalon-core' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
		...
		$this->add_control(
			...
			[
				'label'      => esc_html__( 'Border Radius', 'msalon-core' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'separator'  => 'before',
				'size_units' => [ 'px' ],
				'selectors'  => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Form Fields Styles', 'msalon-core' ),
				'tab'   => Controls_Manager::TAB_STYLE
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Input Field Background', 'msalon-core' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Input Width', 'msalon-core' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', '%' ],
				'range'      => [
					'px' => [
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Textarea Width', 'msalon-core' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', '%' ],
				'range'      => [
					'px' => [
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Fields Padding', 'msalon-core' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
		...
		$this->add_control(
			...
			[
				...
				'label'     => esc_html__( 'Focus State Style', 'msalon-core' ),
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Border Color', 'msalon-core' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Color & Typography', 'msalon-core' ),
				'tab'   => Controls_Manager::TAB_STYLE
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Label Color', 'msalon-core' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Field Font Color', 'msalon-core' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Placeholder Font Color', 'msalon-core' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'type'      => Controls_Manager::HEADING,
				'label'     => esc_html__( 'Label Typography', 'msalon-core' ),
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'type'      => Controls_Manager::HEADING,
				'label'     => esc_html__( 'Input Fields Typography', 'msalon-core' ),
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Submit Button Styles', 'msalon-core' ),
				'tab'   => Controls_Manager::TAB_STYLE
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Button Width', 'msalon-core' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', '%' ],
				'range'      => [
					'px' => [
		...
		$this->add_responsive_control(
			...
			[
				'label'        => esc_html__( 'Button Alignment', 'msalon-core' ),
				'type'         => Controls_Manager::CHOOSE,
				'label_block'  => true,
				'options'      => [
					'default' => [
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Margin', 'msalon-core' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Padding', 'msalon-core' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
		...
		$this->start_controls_tab( 'normal', [ 'label' => esc_html__( 'Normal', 'msalon-core' ) ] );

		$this->add_control(
			'eael_contact_form_submit_btn_text_color',
			[
				'label'     => esc_html__( 'Text Color', 'msalon-core' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Background Color', 'msalon-core' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_tab( 'eael_contact_form_submit_btn_hover', [ 'label' => esc_html__( 'Hover', 'msalon-core' ) ] );
