...
class Widget_Itl_Pie_Chart extends Widget_Base {
	...
	public function get_title() {
		return __( 'ITL - Pie Chart', 'msalon-core' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
            ...
            [
                'label' => __( 'Pie Chart Settings', 'msalon-core' )
            ]
        );
		$this->add_control(
			'percentage',
			[
				'label'   => __( 'Percentage', 'msalon-core' ),
		...
		$this->add_control(
			'bar_color',
			[
				'label' => __( 'Bar Color', 'msalon-core' ),
		...
		$this->add_control(
			'track_color',
			[
				'label' => __( 'Track Color', 'msalon-core' ),
				'type' => Controls_Manager::COLOR,
				'default' => "#f7f7f7",
			]
		);
		$this->add_control(
			'line_width',
			[
				'label' => __( 'Line Width', 'msalon-core' ),
		...
		$this->add_control(
			'line_cap',
			[
				'label'       => __( 'Line Cap', 'msalon-core' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'round',
				'options' => [
					'round'  => __( 'Round', 'msalon-core' ),
